                    ...
                    <div key={i} className="flex-1 border-l border-slate-700/20 h-full flex justify-center relative overflow-hidden">
                        {isCenter ? (
                            <>
                                ...
                                <div
                                    className="absolute top-0 left-1/2 -translate-x-1/2 w-[2px] h-[300px] rounded-full bg-gradient-to-b from-transparent via-blue-500 to-transparent shadow-[0_0_20px_4px_rgba(22,163,74,0.4)] animate-beam-1"

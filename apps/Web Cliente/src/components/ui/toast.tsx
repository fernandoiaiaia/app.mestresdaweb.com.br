...
const styleMap: Record<ToastType, { bg: string; border: string; icon: string; bar: string }> = {
    success: { bg: "bg-slate-800/95", border: "border-blue-500/30", icon: "text-blue-400", bar: "bg-blue-500" },
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3 p-4 pr-10">
                                    <div className={`mt-0.5 ${style.icon}`}><Icon size={20} /></div>
                                ...
                                <button onClick={(e) => { e.stopPropagation(); removeToast(t.id); }}
                    ...
                    return (
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                            ...
                            <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }}
                                ...
                                className="relative w-full max-w-sm mx-4 bg-slate-800/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    {confirmState.options.description && <p className="text-sm text-slate-400 mb-6 leading-relaxed">{confirmState.options.description}</p>}

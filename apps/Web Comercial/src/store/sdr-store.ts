...
const mockIdentities: Identity[] = [
    {
        id: "id_1", name: "João Silva", email: "joao@mestresdaweb.com", emailStatus: "connected", warmupLevel: 85,
    ...
    {
        id: "id_2", name: "Maria Santos", email: "maria@mestresdaweb.com", emailStatus: "warming", warmupLevel: 45,

        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/dashboard/clients/companies/new" className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-blue-600/20">
                    ...
                    >
                        ...
                        <button
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Link href={`/dashboard/clients/companies/${company.id}/edit`} className="p-1.5 rounded-lg text-slate-600 hover:text-blue-400 hover:bg-blue-400/10 transition-all">
                                    <Edit3 size={14} />
                                </Link>

        ...
        return (
            <div className="p-6 md:p-10 max-w-3xl mx-auto">
                <div className="flex items-center gap-2 mb-6">
                    <Link href="/dashboard/management/settings/integrations" className="flex items-center gap-1.5 text-slate-500 hover:text-slate-300 transition-colors text-sm">
                ...
                {providerId === "inbound_webhook" && (
                    <div className="mb-6 bg-slate-800/40 border border-white/[0.06] rounded-2xl p-6 relative overflow-hidden">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <a href="/dashboard/management/settings/integrations/tutorial-html" className="flex items-center gap-2 px-4 py-2 bg-[#E34F26]/10 hover:bg-[#E34F26]/20 border border-[#E34F26]/30 text-[#FF7F59] rounded-xl text-xs font-semibold transition-all">
                                HTML Personalizado
                            </a>

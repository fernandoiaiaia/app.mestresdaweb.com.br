...
export const initialIntegrations: Integration[] = [
    // ═══ PROPOSTAS ═══
    { id: "proposal_openai", name: "OpenAI (Propostas)", description: "Motor de IA para geração automática de checklists, escopos, estimativas de projetos e contratos.", icon: Zap, category: "Propostas", status: "disconnected", lastSync: null, details: "GPT-5.4 · Geração inteligente", configFields: [{ label: "API Key", key: "apiKey", placeholder: "sk-proj-...", value: "" }, { label: "Modelo", key: "model", placeholder: "gpt-5.4", value: "gpt-5.4" }, { label: "Max Tokens", key: "maxTokens", placeholder: "4096", value: "4096" }, { label: "Temperature", key: "temperature", placeholder: "0.7", value: "0.7" }] },
    ...
    { id: "proposal_minimax", name: "MiniMax M2.7 (Propostas)", description: "Motor de IA da MiniMax para geração de escopos, módulos, telas e funcionalidades nas propostas. Modelo M2.7 com compatibilidade nativa Anthropic API.", icon: Zap, category: "Propostas", status: "disconnected", lastSync: null, details: "MiniMax M2.7 · Token Plan", configFields: [{ label: "API Key", key: "apiKey", placeholder: "sk-minimax-...", value: "" }, { label: "Modelo", key: "model", placeholder: "MiniMax-M2.7", value: "MiniMax-M2.7" }, { label: "Max Tokens", key: "maxTokens", placeholder: "8192", value: "8192" }] },
    ...
    // ═══ SDR AUTOMÁTICO ═══
    { id: "sdr_anthropic", name: "Anthropic (Claude IA)", description: "Motor de IA para personalização de mensagens, qualificação de leads e análise de respostas e contratos.", icon: Zap, category: "SDR Automático", status: "disconnected", lastSync: null, details: "Model: claude-sonnet-4.6 · IA Avançada", configFields: [{ label: "API Key", key: "apiKey", placeholder: "sk-ant-api03-...", value: "" }, { label: "Modelo", key: "model", placeholder: "claude-sonnet-4.6", value: "claude-sonnet-4.6" }, { label: "Max Tokens", key: "maxTokens", placeholder: "4096", value: "4096" }] },
    ...
    { id: "inbound_webhook", name: "Webhook (Receber Leads)", description: "Receba leads de sites e landing pages (Elementor, RD Station, Zapier, etc) distribuídos em Round-Robin entre seus vendedores.", icon: Webhook, category: "Marketing", status: "disconnected", lastSync: null, details: "Cria Contatos e Oportunidades nativamente", webhookUrl: "", configFields: [{ label: "Chave Secreta (Gerar Nova)", key: "secretToken", placeholder: "Digite ou gere um token seguro...", value: "" }] },

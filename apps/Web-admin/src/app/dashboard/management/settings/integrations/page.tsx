...
const initialApiKeys: ApiKey[] = [
    ...
    { id: uid(), name: "Webhook - Stripe", key: "sk_test_12345", type: "secret", createdAt: "20 Jan 2026", lastUsed: "04 Mar 2026", permissions: ["webhook:receive", "write:proposals"], status: "active" },
    { id: uid(), name: "Integração CRM", key: "sk_test_67890", type: "secret", createdAt: "01 Fev 2026", lastUsed: null, permissions: ["read:clients", "write:clients"], status: "active" },
...
export default function IntegrationsPage() {
    ...
    const handleCardClick = (integ: Integration) => {
        ...
        router.push(`/dashboard/management/settings/integrations/${integ.id}`);
    };

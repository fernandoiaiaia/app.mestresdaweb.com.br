  ...
  companyCnpj: "44.555.666/0001-99"
    ...
    return (
        <div className="p-6 md:p-10 max-w-4xl mx-auto min-h-screen pb-20 text-slate-300">
            {/* Header */}
            <div className="mb-8">
                <Link href="/dashboard/management/settings/integrations/inbound_webhook" className="flex items-center gap-2 text-slate-500 hover:text-slate-300 transition-colors text-sm mb-6 w-fit">

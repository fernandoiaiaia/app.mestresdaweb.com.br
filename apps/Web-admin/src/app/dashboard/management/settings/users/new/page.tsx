...
/* COMPONENT                               */
/* ═══════════════════════════════════════ */
export default function NewCorporateUserPage() {
    ...
    // new users are always created as USER; promoting to ADMIN is a separate, more
        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto">
            ...
            >
                ...
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-slate-700">/</span>
                    <span className="text-emerald-400 text-sm font-medium">Novo Usuário</span>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-white tracking-tight">Novo Usuário — Corporate</h1>

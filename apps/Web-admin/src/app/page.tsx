            ...
            <main className="relative z-10 flex-1 flex items-center">
                <div className="w-full max-w-7xl mx-auto px-6 md:px-10 py-10 grid grid-cols-1 lg:grid-cols-12 gap-x-4 gap-y-10 items-center">
                    ...
                    <div className="col-span-1 lg:col-span-6 flex flex-col justify-center">
                        ...
                        >
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-300 to-slate-500">Admin Hub.</span>
                        </motion.h1>
                        ...
                        >
                            Gestão financeira e administrativa avançada para gerar resultados de escala.
                        </motion.p>
                    </div>

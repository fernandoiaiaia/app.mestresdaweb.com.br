...
import { connechScopeEditRoutes } from "./modules/integrations/connech-scope-edit.routes.js";
import { connechAdvisorsRoutes } from "./modules/integrations/connech-advisors.routes.js";
import { sdrRoutes } from "./modules/sdr/sdr.routes.js";
import { integrationsRoutes } from "./modules/integrations/integrations.routes.js";
import { googleIntegrationRoutes } from "./modules/integrations/google-calendar.controller.js";
...
import { companyBranchesRoutes } from "./modules/company-branches/company-branches.routes.js";
import { investmentsRoutes } from "./modules/investments/investments.routes.js";
import { profitDistributionRoutes } from "./modules/profit-distribution/profit-distribution.routes.js";
...
import { financialTransactionsRoutes } from "./modules/financial/transactions.routes.js";
import { creditCardsRoutes } from "./modules/financial/credit-cards.routes.js";
import { taxInvoicesRoutes } from "./modules/financial/tax-invoices.routes.js";
...
import { transactionTypesRoutes } from "./modules/transaction-types/transaction-types.routes.js";
...
import { emailTemplatesRoutes } from "./modules/contracts/email-templates/email-templates.routes.js";
import { contractTemplatesRoutes } from "./modules/contracts/contract-templates/contract-templates.routes.js";
import { contractAnalysisRoutes } from "./modules/contracts/analysis/analysis.routes.js";
...
app.use(compression({
    filter: (req, res) => {
        if (req.headers["accept"] === "text/event-stream") {
            return false; // Prevent buffering SSE streams
        }
...
app.use("/uploads/avatars", (_req, res, next) => {
    ...
    next();
}, express.static(path.resolve(process.cwd(), "storage", "uploads", "avatars")));

app.use("/uploads", authMiddleware, (_req, res, next) => {
    res.setHeader("Cross-Origin-Resource-Policy", "cross-origin");
    next();
...
app.use("/api/integrations/connech", connechScopeEditRoutes);
app.use("/api/integrations/connech", connechAdvisorsRoutes);
...
app.use("/api/financial/cards", creditCardsRoutes);
app.use("/api/financial/tax-invoices", taxInvoicesRoutes);
...
// Contratos
app.use("/api/contracts/email-templates", emailTemplatesRoutes);
app.use("/api/contracts/templates", contractTemplatesRoutes);
app.use("/api/contracts/analysis", contractAnalysisRoutes);

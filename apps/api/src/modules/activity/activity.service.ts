...
export const activityService = {
    ...
    async seedIfEmpty(userId: string) {
        ...
        const logs = [
            ...
            { action: "Tentativa de Login Falhou", description: "2 tentativas de login falharam para o e-mail admin@cezani.dev", userName: "Desconhecido", userRole: "N/A", target: "Sistema", category: "auth", ip: "45.67.xxx.xxx" },

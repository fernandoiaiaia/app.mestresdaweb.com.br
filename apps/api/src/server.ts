...
import { migrateSettingsToOwner } from "./lib/migrate-settings-to-owner.js";
...
async function bootstrap() {
    ...
    // Runs once before the server accepts requests — previously registered as an
    // Express middleware placed after every route, so it was dead code (a matched
    // route always responds before the chain reaches it). See migrate-settings-to-owner.ts.
    await migrateSettingsToOwner();

...
const reports: ReportCard[] = [
    ...
    {
        id: "sales-report", title: "Vendas Realizadas", description: "Lista completa de negócios fechados como venda, com filtros por período, vendedor, origem e funil.",
        icon: CheckCircle2, color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/20",
        href: "/dashboard/manager/reports/sales", category: "manager", tags: ["Vendas", "Fechados"],
    },
];

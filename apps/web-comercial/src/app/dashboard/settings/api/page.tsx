...
const mockKeys: ApiKey[] = [
    ...
    { id: "k2", name: "Webhook - Stripe", key: "sk_test_12345", createdAt: "20 Jan 2026", lastUsed: "04 Mar 2026", permissions: ["webhook:receive", "write:payments"], status: "active" },
    { id: "k3", name: "Integração CRM", key: "sk_test_67890", createdAt: "01 Fev 2026", lastUsed: null, permissions: ["read:clients", "write:clients"], status: "active" },

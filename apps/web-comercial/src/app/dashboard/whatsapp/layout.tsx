...
import { MessageSquare, LayoutDashboard, Trello, Tags, Bot } from "lucide-react";
        ...
        <div className="h-screen flex overflow-hidden relative">
            ...
            <div className="w-16 bg-slate-950/10 backdrop-blur-sm border-r border-white/5 flex flex-col items-center py-6 gap-6 z-20 shrink-0">
                ...
                <Link 
                    ...
                    title="Chatbot"
                    className={`w-10 h-10 flex items-center justify-center rounded-xl transition-colors ${pathname === "/dashboard/whatsapp/chatbot" ? "bg-blue-500/20 text-blue-400" : "text-slate-500 hover:text-slate-300 hover:bg-white/5"}`}
                >
                    <Bot size={20} />
                </Link>

...
export default function LoginPage() {
    ...
    // Initialize Google Sign-In SDK (no rendered button — we use our own custom button)
    useEffect(() => {
    ...
    const showGoogleButton = true; // Always show custom styled Google button
            ...
            <main className="relative z-10 flex-1 flex items-center">
                <div className="w-full max-w-7xl mx-auto px-6 md:px-10 py-10 grid grid-cols-1 lg:grid-cols-12 gap-x-4 gap-y-10 items-center">
                    ...
                    <div className="col-span-1 lg:col-span-6 flex flex-col justify-center">
                        ...
                        >
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-300 to-slate-500">Advisor Hub.</span>
                        </motion.h1>
                        ...
                        >
                            Consultorias com inteligência artificial avançada para gerar resultados que superam expectativas reais.
                        </motion.p>
                    </div>
                                ...
                                {step === "credentials" && (
                                    ...
                                    >
                                        <form className="space-y-5" onSubmit={handleLogin}>
                                            ...
                                            {showGoogleButton && (
                                                <div className="relative w-full h-[46px] rounded-[10px] overflow-hidden group">

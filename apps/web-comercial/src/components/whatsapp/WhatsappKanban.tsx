...
import { Search, Plus, MoreHorizontal, MessageCircle, Clock, AlertCircle, Users, ChevronDown } from "lucide-react";
                    ...
                    {isManagerOrOwner && teamMembers.length > 0 && (
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="appearance-none pl-9 pr-10 py-2.5 bg-slate-800 border border-white/10 rounded-xl text-sm text-white focus:outline-none focus:border-blue-500/50 font-medium cursor-pointer transition-all"
                            >
